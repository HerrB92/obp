...
/**
 * Test class for testing tag data encoded using protocol 42 (RFBPROTO_PROXTRACKER).
 * 
...
public class TestTagSightingProtocol42 {
	...
	public final void testTagSighting() {
		...
		payload[0] = (byte)Constants.RFBPROTO_PROXTRACKER;	// Tag protocol
		...
		payload[5] = (byte)0x04;							// oid Last Seen? (1) 
		payload[6] = (byte)0xf4;							// oid Last Seen? (2)
		payload[7] = 0;										// PowerUp Count? (1)
		payload[8] = 0;										// PowerUp Count? (2)
		payload[9] = 0;										// Reserved
		payload[10] = 0;									// Sequence (1), some value
		payload[11] = 0;									// Sequence (2)
		payload[12] = (byte)0x02;							// Sequence (3)
		payload[13] = (byte)0x01;							// Sequence (4)
		...
		assertEquals(42, tagSighting.getTagProtocol());
		...
		assertEquals("89,90,1,1,4,244,0,32,0,0,1,176,0,17,46,151,105,180,59,212,186,65,62,151,218,14,166,71,92,19,8,72",
